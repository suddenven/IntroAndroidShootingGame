    ...
    public class DrawViewThread extends Thread{
        ...
        public void run() {
            ...
            while (threadIsRunning) {
                ...
                try {
                    // lock the canvas for updating
                    //only the surface view can update the canvas
                    //It is like editing behind the scenes, only uodating the view when editing has been completed on a separate thread.
                    ...
                    if (canvas != null)
                        //after canvas has been updated, unlock it and redraw it on the user interface.
