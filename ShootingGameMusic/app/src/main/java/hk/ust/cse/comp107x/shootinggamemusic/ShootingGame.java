...
public class ShootingGame extends AppCompatActivity implements View.OnClickListener {
    ...
    // true when the music should be played, false otherwise
    Menu menu;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       //Create the MediaPlayer and initialize it
    ...
    protected void onDestroy() {
        ...
        //shut down the media player when user quits the application
        player.stop();
        player.reset();
        player.release();
        player = null;
